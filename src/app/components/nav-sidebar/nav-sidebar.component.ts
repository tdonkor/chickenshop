...
export class NavSidebarComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  public get navigationButtons(): any {
    return this.page.NavigationButtons.filter((val) => {
      return val.Picture !== null && val.Picture !== '';
    });
  }
  ...
  public ngOnInit(): void {
    this.subscriptions.push(
      this.activatedRoute.paramMap.subscribe((params) => {
        ...
        this.selectedNavButtonLink = this.navButtons.find((btn) => this.checkPageContainsLinkInDepth(getPage(btn.Link, true)))?.Link;
